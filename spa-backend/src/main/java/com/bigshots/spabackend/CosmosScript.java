...
public class CosmosScript {
	...
	public void buildTableOverCloud() {
		...
		String mySqlUrl = "jdbc:mysql://127.0.0.1:3306/jokeschema?useSSL=false&serverTimezone=UTC";
		String mySqlUsername = "root";
		String mySqlPassword = "BigSimon9!";
...
/*
	...
	//not sure if it will let you log into mine so if you create your account plug in the values 
	client = new CosmosClientBuilder()
			.endpoint("https://quintrixsolo.documents.azure.com:443/")
			.key("Qm3LKpe5kRyRhpVGyjtXQxzRcAmuS7J9fuSguR5IrF2UlWFO0LvEyZQsqoMifntnrrljrhW9zAcrDhXGYjBdHA==")
			.buildClient();
	...
	try {
		...
		//change this to your mysql login credentials
		Connection conn = DriverManager.getConnection(myUrl, "root", "BigSimon9!");
